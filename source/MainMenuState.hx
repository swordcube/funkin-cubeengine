...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 44, 0, "Cube Engine v" + EngineStuff.engineVersion, 12);
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				else
				{
					...
					if(GamePrefs.flashingLights) FlxFlicker.flicker(magenta, 1.1, 0.15, false);
